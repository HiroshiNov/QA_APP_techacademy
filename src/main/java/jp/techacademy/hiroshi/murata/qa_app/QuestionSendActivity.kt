...
class QuestionSendActivity : AppCompatActivity(), View.OnClickListener, DatabaseReference.CompletionListener{
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == CHOOSER_REQUEST_CODE) {
            ...
            //Resize the Bitmap's longer side length into 500 px
    ...
    override fun onClick(v: View) {
        if (v == imageView) {
            ...
            //Close if keyboard is being displayed
            ...
            if (body.isEmpty()) {
                //if Question is Empty, Display error
            ...
            //Encode image into BASE64 if attached image is setting
            if (drawable != null) {
